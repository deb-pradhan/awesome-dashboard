...
// BTC Price Data (30-day OHLCV)
const priceData = [
  { date: 'Nov 18', open: 92215, high: 93836, low: 89254, close: 92961, volume: 3.64e9 },
  { date: 'Nov 19', open: 92961, high: 92980, low: 88608, close: 91555, volume: 2.93e9 },
  { date: 'Nov 20', open: 91555, high: 93160, low: 86100, close: 86637, volume: 3.55e9 },
  { date: 'Nov 21', open: 86637, high: 87499, low: 80600, close: 85129, volume: 6.06e9 },
  ...
  { date: 'Nov 24', open: 86830, high: 89228, low: 85272, close: 88300, volume: 2.15e9 },
  { date: 'Nov 25', open: 88300, high: 88520, low: 86116, close: 87370, volume: 1.71e9 },
  { date: 'Nov 26', open: 87370, high: 90656, low: 86307, close: 90484, volume: 1.92e9 },
  { date: 'Nov 27', open: 90484, high: 91950, low: 90090, close: 91334, volume: 1.54e9 },
  { date: 'Nov 28', open: 91334, high: 93092, low: 90181, close: 90891, volume: 1.72e9 },
  { date: 'Nov 29', open: 90891, high: 91166, low: 90155, close: 90802, volume: 674e6 },
  { date: 'Nov 30', open: 90802, high: 92000, low: 90337, close: 90360, volume: 884e6 },
  { date: 'Dec 01', open: 90360, high: 90417, low: 83823, close: 86286, volume: 2.98e9 },
  { date: 'Dec 02', open: 86286, high: 92308, low: 86184, close: 91278, volume: 2.52e9 },
  { date: 'Dec 03', open: 91278, high: 94150, low: 90990, close: 93430, volume: 2.39e9 },
  { date: 'Dec 04', open: 93430, high: 94080, low: 90889, close: 92078, volume: 1.84e9 },
  { date: 'Dec 05', open: 92078, high: 92692, low: 88056, close: 89330, volume: 1.79e9 },
  { date: 'Dec 06', open: 89330, high: 90290, low: 88908, close: 89237, volume: 753e6 },
  { date: 'Dec 07', open: 89237, high: 91760, low: 87719, close: 90395, volume: 1.17e9 },
  { date: 'Dec 08', open: 90395, high: 92287, low: 89612, close: 90634, volume: 1.44e9 },
  ...
  { date: 'Dec 11', open: 92015, high: 93555, low: 89261, close: 92513, volume: 1.81e9 },
  { date: 'Dec 12', open: 92513, high: 92754, low: 89480, close: 90268, volume: 1.52e9 },
  { date: 'Dec 13', open: 90268, high: 90635, low: 89766, close: 90240, volume: 532e6 },
  { date: 'Dec 14', open: 90240, high: 90472, low: 87577, close: 88172, volume: 839e6 },
  { date: 'Dec 15', open: 88172, high: 90053, low: 85147, close: 86432, volume: 1.73e9 },
  { date: 'Dec 16', open: 86432, high: 88176, low: 85266, close: 87863, volume: 1.60e9 },
  { date: 'Dec 17', open: 87863, high: 87950, low: 86209, close: 87460, volume: 623e6 },
];

// RSI Data
const rsiData = [
  { date: 'Dec 01', rsi: 22.37 },
  ...
  { date: 'Dec 17', rsi: 37.32 },
];

// Stochastic Data
const stochData = [
  { date: 'Dec 03', k: 74.22, d: 0 },
  { date: 'Dec 04', k: 88.14, d: 0 },
  ...
  { date: 'Dec 17', k: 22.26, d: 29.24 },
];

// Bollinger Bands Data
const bollingerData = [
  { date: 'Dec 07', close: 90395, upper: 94590, middle: 89471, lower: 84353 },
  ...
  { date: 'Dec 17', close: 87442, upper: 94202, middle: 90117, lower: 86033 },
];

// Funding Rate Comparison (Binance vs Bybit)
const fundingRateData = [
  { date: 'Dec 14 12:00', binance: 0.00000377, bybit: 0.00000145 },
  { date: 'Dec 14 20:00', binance: 0.00000019, bybit: 0.00000029 },
...
const openInterestData = [
  { date: 'Nov 18', binance: 101319, bybit: 60664 },
...
const tokenRatingScores = [
  { metric: 'Overall Rating', value: 2.56, max: 10 },
  { metric: 'Accumulation', value: 9, max: 10 },
  { metric: 'Leverage', value: 7, max: 10 },
  { metric: 'Demand Shock', value: 2, max: 10 },
  { metric: 'Price Strength', value: 1, max: 10 },
  { metric: 'Sentiment', value: 0, max: 10 },
];

// ATR Data
const atrData = [
  { date: 'Dec 01', atr: 3803 },
  ...
  { date: 'Dec 17', atr: 3402 },
];

// OBV Data
const obvData = [
  { date: 'Dec 01', obv: -165588 },
  ...
  { date: 'Dec 17', obv: -149125 },
];

// Overall Rating History
const ratingHistory = [
  { date: 'Nov 17', rating: 30.00 },
  ...
  { date: 'Dec 16', rating: 25.56 },
];

// Key levels
const keyLevels = [
  { level: 'Strong Resistance', price: '$94,500-95,000', basis: '50 SMA, December highs' },
  { level: 'Resistance', price: '$90,000-91,000', basis: '20 EMA, psychological' },
  { level: 'Current Price', price: '$87,425', basis: '-' },
...
// Price summary table
const priceSummary = [
  { metric: '30-Day High', value: '$94,589', date: 'Dec 9' },
  { metric: '30-Day Low', value: '$80,600', date: 'Nov 21' },
  { metric: '30-Day Range', value: '$13,989', date: '17.4%' },
  { metric: 'Avg Daily Volume', value: '$1.76B', date: '-' },
];

// Bull/Bear signals
const bullSignals = [
  'Stochastic deeply oversold at 22.26 - bounce probability high',
  'Accumulation Score 9/10 - smart money buying',
  'Sentiment at extreme lows (contrarian indicator)',
  'Open interest deleveraged from November highs',
  'Price at Bollinger lower band support',
  'Funding rates positive but not extreme',
];

const bearSignals = [
  'Trading below 20 EMA ($89,372) and 50 SMA ($94,942)',
  'OBV showing distribution pattern',
  'No Divine Dip signal yet (could go lower)',
  'Weak price strength and demand shock scores',
  'RSI at 37.32 - not yet oversold',
];
    ...
    <div className="min-h-screen bg-[var(--surface-canvas)] p-6">
      ...
      <header className="mb-8">
        <div className="flex items-baseline gap-4 mb-2">
          ...
          <span className="label-micro text-[var(--color-accent-main)]">LIVE DATA</span>
        </div>
        <div className="flex items-center gap-4 text-[var(--ink-secondary)]">
          <span className="body-text">December 17, 2025</span>
          <span className="text-[var(--border-grid)]">|</span>
          <span className="label-micro">SOURCE: PANDA MCP + JLABS ANALYTICS</span>
        </div>
      </header>

      {/* Executive Summary Metrics */}
      <section className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 mb-0">
        <MetricCard label="BTC Price" value="$87,425" change="+0.43% 24h" trend="up" />
        <MetricCard label="RSI (14)" value="37.32" change="Neutral-Weak" trend="down" />
        <MetricCard label="Stochastic %K" value="22.26" change="Oversold" trend="down" />
        <MetricCard label="Open Interest" value="$12.2B" change="Binance + Bybit" trend="neutral" />
        <MetricCard label="Funding Rate" value="0.009%" change="Bullish" trend="up" />
        <MetricCard label="Token Rating" value="25.56" change="Weak" trend="down" />
      </section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
        ...
        <GridCard title="RSI (14-Period)" icon={<Activity />}>
          ...
          <div className="mt-2 flex justify-between items-center">
            ...
            <span className="data-numerical text-[var(--ink-primary)]">Current: 37.32</span>
            <div className="flex items-center gap-2">
        ...
        <GridCard title="Stochastic Oscillator (14,3,3)" icon={<Activity />}>
          ...
          <div className="mt-2 p-3 bg-[var(--signal-success)]" style={{ backgroundColor: 'rgba(0, 110, 80, 0.1)' }}>
            <span className="label-micro text-[var(--signal-success)]">OVERSOLD SIGNAL</span>
            <p className="body-text text-[var(--ink-primary)] mt-1">
              %K at 22.26 below 20 threshold - potential bounce incoming
            </p>
          </div>
        </GridCard>
        ...
        <GridCard title="Bollinger Bands (20,2)" icon={<BarChart3 />}>
          ...
          <div className="mt-2 grid grid-cols-3 gap-2 text-center">
            <div className="p-2 border border-[var(--signal-error)]">
              ...
              <span className="data-numerical block">$94,202</span>
            </div>
            <div className="p-2 border border-[var(--border-element)]">
              <span className="label-micro text-[var(--ink-secondary)]">Middle</span>
              <span className="data-numerical block">$90,117</span>
            </div>
            <div className="p-2 border border-[var(--signal-success)]">
              <span className="label-micro text-[var(--signal-success)]">Lower</span>
              <span className="data-numerical block">$86,033</span>
            </div>
          </div>
        </GridCard>

        {/* Funding Rates */}
        <GridCard title="Funding Rate Comparison" icon={<Zap />} className="xl:col-span-2">
          <FundingCompareChart data={fundingRateData} />
          <div className="mt-4 grid grid-cols-3 gap-4">
            <div className="p-3 bg-[var(--surface-subtle)] border border-[var(--border-element)]">
              <span className="label-micro text-[var(--ink-secondary)] block mb-1">Binance Latest</span>
              <span className="data-numerical text-[var(--signal-success)]">0.00899%</span>
              <span className="label-micro text-[var(--ink-tertiary)] block">~78.75% annualized</span>
            </div>
            <div className="p-3 bg-[var(--surface-subtle)] border border-[var(--border-element)]">
              <span className="label-micro text-[var(--ink-secondary)] block mb-1">Bybit Latest</span>
              <span className="data-numerical text-[var(--signal-success)]">0.00460%</span>
              <span className="label-micro text-[var(--ink-tertiary)] block">~40.30% annualized</span>
            </div>
            <div className="p-3 bg-[var(--surface-subtle)] border border-[var(--border-element)]">
              <span className="label-micro text-[var(--ink-secondary)] block mb-1">Sentiment</span>
              <span className="data-numerical text-[var(--signal-success)]">Moderately Bullish</span>
        ...
        <GridCard title="Open Interest (Binance + Bybit)" icon={<Database />}>
          ...
          <div className="mt-2 flex justify-between text-center">
            <div>
              ...
              <span className="data-numerical block text-[var(--color-accent-main)]">88,599 BTC</span>
            </div>
            <div>
              <span className="label-micro text-[var(--ink-secondary)]">Bybit</span>
              <span className="data-numerical block" style={{ color: '#E6B000' }}>50,899 BTC</span>
            </div>
            <div>
              <span className="label-micro text-[var(--ink-secondary)]">Total</span>
              <span className="data-numerical block text-[var(--ink-primary)]">139,498 BTC</span>
            </div>
          </div>
        </GridCard>

        {/* Token Rating Scores */}
        <GridCard title="JLabs Token Rating (Dec 16)" icon={<Shield />}>
          ...
          <div className="mt-2 p-3 bg-[var(--color-accent-subtle)] border border-[var(--color-accent-main)]">
            ...
            <p className="body-text text-[var(--ink-primary)] mt-1">
              High Accumulation (9/10) + Low Sentiment (0/10) = Classic smart money accumulation pattern
            </p>
          </div>
        </GridCard>
        ...
        <GridCard title="Overall Rating History" icon={<TrendingUp />}>
          ...
          <div className="mt-2 text-center">
            <span className="data-numerical text-[var(--ink-primary)]">Rating dropped from 41 → 25.56 over 30 days</span>
          </div>
        </GridCard>
        ...
        <GridCard title="Average True Range (14)" icon={<Activity />}>
          ...
          <div className="mt-2 p-3 bg-[var(--surface-subtle)] border border-[var(--border-element)]">
            ...
            <p className="body-text text-[var(--ink-primary)] mt-1">
              ATR declining from $3,900 → $3,402. Often precedes significant moves.
            </p>
          </div>
        </GridCard>
        ...
        <GridCard title="On-Balance Volume" icon={<BarChart3 />}>
          ...
          <div className="mt-2 p-3 bg-[var(--signal-error)]" style={{ backgroundColor: 'rgba(179, 38, 30, 0.1)' }}>
            ...
            <p className="body-text text-[var(--ink-primary)] mt-1">
              OBV deeply negative indicating more volume on down days
          </p>
        </div>
        </GridCard>

        {/* Hyperliquid Data */}
        <GridCard title="Hyperliquid Live Data" icon={<Zap />} noPadding>
          <DataTable 
            ...
            rows={[
              ...
              ['Oracle Price', '$87,469'],
              ['24h Volume', '$1.98B'],
              ['Open Interest', '23,680 BTC'],
              ['Funding Rate', '0.000447%'],
              ['Premium', '-0.0697%'],
              ['Max Leverage', '40x'],
            ]}
          />
        ...
        <GridCard title="Key Triggers to Watch" icon={<AlertTriangle />}>
          <div className="space-y-3">
            ...
            <div className="p-3 bg-[var(--surface-subtle)] border border-[var(--border-element)]">
              <span className="label-micro text-[var(--ink-secondary)]">INVALIDATION</span>
              <p className="data-numerical text-[var(--ink-primary)] mt-1">Bear: Close above $95,000 | Bull: Below $80,600</p>
            </div>
          </div>
        </GridCard>

        {/* Divine Dip */}
        <GridCard title="Divine Dip Indicator" icon={<DollarSign />}>
          <div className="space-y-3">
            <div className="p-3 border border-[var(--signal-success)]" style={{ backgroundColor: 'rgba(0, 110, 80, 0.05)' }}>
              <div className="flex items-center gap-2 mb-2">
                <span className="text-lg">✅</span>
                <span className="label-micro text-[var(--signal-success)]">DIP DETECTED</span>
              </div>
              <p className="body-text text-[var(--ink-secondary)]">Nov 19-21: BTC dropped from $92K to $80.6K</p>
            </div>
            <div className="p-3 border border-[var(--border-element)]">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-lg">❌</span>
                <span className="label-micro text-[var(--ink-secondary)]">NO SIGNAL</span>
              </div>
              <p className="body-text text-[var(--ink-secondary)]">Nov 22 - Dec 17: Current decline gradual, no panic signal</p>
            </div>
          </div>
        </GridCard>
      </div>
      ...
      <footer className="mt-8 pt-6 border-t border-[var(--border-grid)]">
        <div className="flex items-center justify-between text-[var(--ink-tertiary)]">
          <span className="label-micro">DATA SOURCES: BINANCE, BYBIT, HYPERLIQUID VIA PANDA MCP | JLABS ANALYTICS</span>
